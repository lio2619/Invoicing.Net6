...
namespace invoicing.Forms
{
    public partial class IncomingOrderForm : Form
    {
        ...
        private void saveOrderButton_Click(object sender, EventArgs e)
        {
            ...
            CommonButtonFunction commonButtonFunction = new CommonButtonFunction(productDetailData, dateOnly, storeName, remark, totalPrice, "進貨單");
        ...
        {
            SearchOrderForm searchOrderForm = new SearchOrderForm("進貨單", productDetailData, orderNumber, totalMoney, remarkTextBox, customerName, dateTime);
        ...
        private void createExcelButton_Click(object sender, EventArgs e)
        {
            ...
            string path = "../單子/" + dateMonth + "/進貨單/";
            string fileName = "進貨單_" + dateTime.Value.ToString("yyyy-MM-dd") + "_" + customerName.Text.ToString();
            CreateExcelFunction createExcelFunction = new CreateExcelFunction(productDetailData, dateMonth, dateMonthDay, fileName, orderNumber.Text, customerName.Text, "進貨單");
