...
{
    public partial class ShipmentReturnOrderForm : Form
    {
        private readonly CommonFormFunction commonFormFunction = new CommonFormFunction();
        public ShipmentReturnOrderForm()
        {
            InitializeComponent();
        ...
        private void saveOrderButton_Click(object sender, EventArgs e)
        {
            ...
            CommonButtonFunction commonButtonFunction = new CommonButtonFunction(productDetailData, dateOnly, storeName, remark, totalPrice, "出貨退出單");
        ...
        {
            SearchOrderForm searchOrderForm = new SearchOrderForm("出貨退出單", productDetailData, orderNumber, totalMoney, remarkTextBox, customerName, dateTime);
        ...
        private void createExcelButton_Click(object sender, EventArgs e)
        {
            ...
            string path = "../單子/" + dateMonth + "/出貨退出單/";
            string fileName = "出貨退出單_" + dateTime.Value.ToString("yyyy-MM-dd") + "_" + customerName.Text.ToString();
            CreateExcelFunction createExcelFunction = new CreateExcelFunction(productDetailData, dateMonth, dateMonthDay, fileName, orderNumber.Text, customerName.Text, "出貨退出單");
